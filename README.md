...
HaiTun 是真知出品的全场景本地 AI 智能体。你只需要用自然语言说明目标，它可以帮你处理写代码、做设计、写报告、做分析、整理文件、清洗数据、转换格式和批量操作等任务。
...
[下载 Windows 版](https://github.com/genuineknowledge/haitun/releases/latest/download/HaitunAgent_Setup.exe)

支持 Windows 10 / 11 x64，兼容 ARM64。

安装后打开 HaiTun，用自然语言告诉它你想完成什么，例如：
...
HaiTun 可以自动完成文件整理、数据清洗、格式转换、批量操作等重复性工作，减少手动处理流程。
...
HaiTun 会基于执行反馈优化任务策略，并持续适配更多个人和团队工作流。
...
HaiTun 本身在本地运行。部分需要调用在线模型或网络资源的功能会使用网络，其余本地能力可离线运行。
