...
HaiTun Agent 是[真知智能](http://www.genuine-knowledge.com/)出品的全场景本地 AI 智能体。你只需要用自然语言说明目标，它可以帮你处理写代码、做设计、写报告、做分析、整理文件、清洗数据、转换格式和批量操作等任务。
...
- [开发源码](https://github.com/genuineknowledge/psi-agent)
- [历史版本](https://github.com/genuineknowledge/haitun/releases)
