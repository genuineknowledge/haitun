...
Write-Host "=== HaiTun Agent 安装程序 ===" -ForegroundColor Cyan
...
if (-not (Test-Path $haitunDir)) {
    ...
    Write-Host "已创建目录: $haitunDir"
} else {
    Write-Host "目录已存在: $haitunDir"
}
...
$downloadUrl = "https://github.com/genuineknowledge/haitun/releases/download/$Version/$file"
